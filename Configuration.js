...
function getEndpoints(deviceAddress, endpoints) {
  ...
  endpoints.addEndpoint("2", "Leak Flag", endpointType.iasSensor, iasEndpointSubType.alarmInput);
  var e = endpoints.addEndpoint("3", "Leak Count", endpointType.genericSensor);
  e.variableTypeId = 1421;
  var e = endpoints.addEndpoint("4", "Leak Time", endpointType.genericSensor);
